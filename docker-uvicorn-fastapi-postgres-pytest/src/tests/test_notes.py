...
def test_create_note(test_app, monkeypatch):
    ...
    monkeypatch.setattr(notes_repository, "post", mock_post)
...
def test_read_note(test_app, monkeypatch):
    ...
    monkeypatch.setattr(notes_repository, "get", mock_get)
...
def test_read_all_notes(test_app, monkeypatch):
    ...
    monkeypatch.setattr(notes_repository, "get_all", mock_get_all)
...
def test_update_note(test_app, monkeypatch):
    ...
    monkeypatch.setattr(notes_repository, "put", mock_put)
...
def test_remove_note(test_app, monkeypatch):
    test_data = {"title": "something",
                 "description": "something else", "id": 1}
    ...
    monkeypatch.setattr(notes_repository, "delete", mock_delete)
